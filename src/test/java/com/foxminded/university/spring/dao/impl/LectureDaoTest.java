...
class LectureDaoTest {
	...
	void When_Get_All_Lectures_Then_True() {
		...
		Audience audience3 = new Audience(0, 0);
		Date date3 = new Date(0, null, null, null);
		Group group3 = new Group(0, course3, null);
		Student student3 = new Student(0, group3, null, null, null, null);
		Teacher teacher3 = new Teacher(0, null, null, null, null);
