...
public class StudentDaoImpl implements StudentDao {
	...
	private static final String SQL_INSERT_STUDENT = "INSERT INTO student ( group_id, student_name, student_phone, student_email, student_adress)"
			+ " VALUES(?,?,?,?,?);";
	...
	public boolean create(Student student) throws DaoException {
		...
		try {
			return jdbcTemplate.update(SQL_INSERT_STUDENT, student.getGroup().getId(), student.getName(),
