...
public class TeacherDaoImpl implements TeacherDao {
	...
	private static final String SQL_INSERT_TEACHER = "INSERT INTO teacher( teacher_name, teacher_phone, teacher_email, teacher_adress) VALUES(?,?,?,?);";
	...
	public boolean create(Teacher teacher) throws DaoException {
		...
		try {
			return jdbcTemplate.update(SQL_INSERT_TEACHER, teacher.getName(), teacher.getPhone(), teacher.getEmail(),
					teacher.getAdress()) > 0;
		} catch (DataAccessException e) {
