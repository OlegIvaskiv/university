...
public class GroupDAOimpl implements GroupDao {
    ...
    private static final String SQL_INSERT_GROUP = "INSERT INTO \"group\"(group_id, course_id, group_name) VALUES(?,?,?);";
    ...
    @Override
    public boolean addGroupToCourse(Optional<Group> group, Optional<Course> course) throws DaoException {
